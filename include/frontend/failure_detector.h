...
public:
    ...
    // Threshold setters
    void setFeatureThreshold(int threshold) {
        feature_threshold_ = threshold;
    }
    void setAccBiasThreshold(double threshold) {
        acc_bias_threshold_ = threshold;
    }
    void setGyrBiasThreshold(double threshold) {
        gyr_bias_threshold_ = threshold;
    }
    void setTranslationThreshold(double threshold) {
        translation_threshold_ = threshold;
    }
    void setZTranslationThreshold(double threshold) {
        z_translation_threshold_ = threshold;
    }
